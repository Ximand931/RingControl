...
public abstract class BaseEditTimetableRecyclerViewAdapter extends BaseRecyclerViewAdapter<Lesson,
        BaseEditTimetableRecyclerViewAdapter.EditTimetableViewHolder> {
    ...
    public BaseEditTimetableRecyclerViewAdapter(List<Lesson> lessons, boolean detailEditing) {
        super(lessons);
